...
public class Attributes implements Map<Object,Object>, Cloneable {
    ...
    public static class Name {
        ...
        /**
         * <code>Name</code> object for <code>cn.code.test.Main-Class</code> manifest
         * attribute used for launching applications packaged in JAR files.
         * The <code>cn.code.test.Main-Class</code> attribute is used in conjunction
         * with the <code>-jar</code> command-line option of the
         * <tt>java</tt> application launcher.
         */
        public static final Name MAIN_CLASS = new Name("cn.code.test.Main-Class");
